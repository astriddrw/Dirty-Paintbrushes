  ...
  return (
    <section className="px-6 lg:px-8 py-8 bg-indigo">
      <div className="max-w-5xl mx-auto flex flex-wrap items-baseline justify-between gap-x-8 gap-y-3">
        <div
          className="flex items-center gap-3 flex-nowrap animate-fade-in-up"
          style={{ animationDelay: '100ms' }}
        >
          <img
            src="/paintbrushes.png"
            alt=""
            className="h-16 lg:h-24 w-auto shrink-0"
          />
          <h1 className="text-4xl lg:text-5xl font-serif italic font-normal leading-tight text-aged-vellum whitespace-nowrap">
            Dirty Paintbrushes
          </h1>
        </div>
